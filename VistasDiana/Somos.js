...
const Somos = () => {
  ...
  return (
    ...
    <h2 className='Ourteam'>¿Quiénes somos?</h2>
      <div className="team-members">
      <div className="Diana">
        <img src={Diana} alt="Diana" />
            <h3>Diana M. Bello L.</h3>
            <h4>FrontEnd</h4>
            <p className='descripcion'> Estudiante de la UN sede Boogotá, centrada en el front</p>
      </div>
      <div className="Julian">
        <img src={Julian} alt="Julian" />
          <h3>Julian Fernández</h3>
          <p className='descripcion'> Estudiante de la UN sede Boogotá, centrado en el desarrollo FullStack</p>
          <p>FullStack</p>
      </div>
